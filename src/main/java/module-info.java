...
module com.onuratilla.ibb_ecodation_javafx {
    ...
    exports com.onuratilla.ibb_ecodation_javafx.dao;

    // // Veritabanı bağlantı paketini dış dünyaya açıyoruz. Diğer modüller DB bağlantısını kullanabilir.
    exports com.onuratilla.ibb_ecodation_javafx.database;

    // Ana paketi dış dünyaya açıyoruz. Diğer modüller bu paketin içeriğini kullanabilir.
    exports com.onuratilla.ibb_ecodation_javafx;
    opens com.onuratilla.ibb_ecodation_javafx.utils to javafx.base, lombok;
}
